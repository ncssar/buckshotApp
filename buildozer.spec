...
##################################################
# NOTE: DO NOT ADD COMMENTS at the end of the same line as the requirements!
...
##################################################
#requirements = python3,kivy,regex,parse,json
#requirements = python3,kivy
# xml.dom.minidom and json come with python
# adding regex module gives 'no valid dependency graphs' 12-20-18
#requirements = python3,kivy,parse
# from https://github.com/kivy/python-for-android/issues/1072#issuecomment-379770443
#requirements = python3,kivy,parse,requests,urllib3,chardet,certifi,idna
# for download-only test:
